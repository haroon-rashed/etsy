...
?>
<div class=" card  top-0 mx-auto flash-message p-3 position-fixed " style="left:50%; transform:translateX(-50%) ; transform:translateY(-105%); opacity:0; transition: all 0.7s; background-color: <?php
if($varient == 'success'){
    echo 'green';
